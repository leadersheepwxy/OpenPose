      ...
      <section id="contact" class="contact">
        <div class="container" data-aos="fade-up">
			...
			<div class="camwindow">
				...
				<video src="{{url_for('static',filename='/img/M.mp4')}}" width="100%" controls muted autoplay="1"></video>
				...
				雙手手掌朝前，自然垂下，並逐漸將雙手與身體同一平面抬起，<br>直至可忍耐的疼痛程度，並於該位置維持10秒再放下。
