	...
	<main id="main" style="margin: -70px 0 0 10%;">
      <section id="contact" class="contact">
        <div class="container" data-aos="fade-up">
			...
			<div class="camwindow">
				<div class="left">
                <video src="{{url_for('static',filename='/img/B.mp4')}}" width="100%" controls muted autoplay="1"></video>
				<!--<video src="./image/B.mp4" width="100%" controls loop></video>-->
				...
				<!-- 資料內容 -->
                    ...
                    <tr>
                        <td style="border-radius: 0 0 5px 5px; padding:5px;">
                            身體直立，將雙臂向後伸展，<br>直至可忍耐的疼痛程度，並於該位置維持10秒再放下。
