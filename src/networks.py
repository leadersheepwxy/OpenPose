...
from src.network_mobilenet import MobilenetNetwork
from src.network_mobilenet_thin import MobilenetNetworkThin
...
def get_graph_path(model_name):
    return {
        ...
        'mobilenet_thin_432x368': './models/graph/mobilenet_thin_432x368/graph_freeze.pb',
    }[model_name]
