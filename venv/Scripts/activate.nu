...
let virtual-env = "D:\KMU\醫務管理暨醫療資訊專題(2)\IntelliJ\tf-pose-estimation-master\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "D:\KMU\醫務管理暨醫療資訊專題(2)\IntelliJ\tf-pose-estimation-master\venv\Scripts\deactivate.nu"
